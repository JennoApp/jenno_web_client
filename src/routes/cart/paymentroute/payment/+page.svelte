...
<div class="w-full h-64 mt-14">
    ...
    <div class="flex flex-col items-center">
      <button
        class="bg-gray-200 dark:bg-[#252525] w-40 h-40 rounded-lg hover:bg-gray-300 dark:hover:bg-[#303030] {$paymentMethod === 'mercadopago' ? 'border-2 border-[#202020] dark:border-gray-200' : ''}"
    ...
    <div class="flex flex-col items-center">
      <button
        class="bg-gray-200 dark:bg-[#252525] w-40 h-40 rounded-lg hover:bg-gray-300 dark:hover:bg-[#303030] {$paymentMethod === 'paypal' ? 'border-2 border-[#202020] dark:border-gray-200' : ''}"
