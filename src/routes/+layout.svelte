...
<svelte:head>
	...
	<meta
		...
		content="Crea tu propia tienda en línea con Jenno y compártela fácilmente en redes sociales. Vende tus productos de forma sencilla y segura."
	/>
	<meta name="twitter:image" content="https://www.jenno.com.co/oplogo.jpg" />
...
<Navigation>
	{#if !$location_data || !$location_data.data || !$location_data.data[0]?.country}
		<!-- Muestra un loader mientras se carga la ubicación -->
		<div class="flex items-center justify-center h-full w-full">
			<span class="text-[#707070] text-sm">Cargando ubicación...</span>
		</div>
	{:else if $location_data.data[0].country !== 'Colombia'}
