...
<div class="flex flex-col justify-center items-center">
	<div class="flex items-center justify-evenly gap-2 bg-gray-200 dark:bg-[#252525] w-3/5 h-24 mt-3 px-3 rounded-t-md">
		<!-- step 1 -->
  ...
  <div class="flex items-center px-14 bg-gray-200 dark:bg-[#252525] w-3/5 h-10 rounded-b-md">
